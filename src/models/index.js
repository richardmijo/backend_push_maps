...
// Relaciones
User.hasMany(DeviceToken, { foreignKey: 'userId', as: 'tokens' });
DeviceToken.belongsTo(User, { foreignKey: 'userId', as: 'user' });

// Relaciones nuevas
User.hasMany(GeoObject, { foreignKey: 'userId', as: 'geoObjects' });
GeoObject.belongsTo(User, { foreignKey: 'userId', as: 'user' });
